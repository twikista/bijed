...
import { signup } from '@/lib/actionsV2/auth';
import { newUserSchema } from '@/lib/schemas/auth';
import Select from '@/components/new/Select';
import { TextInput } from '../new/TextInput';
import FormWrapper from '../new/FormWrapper';
import { SubmitButton, CancelButton } from '@/components/new/buttons';
import { toast } from 'sonner';
import { FullfilledStateLoader, PendingStateLoader } from '../new/Loader';
...
export default function NewUserFormV2() {
  const initialVlaue = {
    firstName: '',
    lastName: '',
    email: '',
